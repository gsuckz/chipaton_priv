...
C {devices/lab_wire.sym} -480 -130 0 0 {name=p27 sig_type=std_logic lab="Vip"}
C {devices/lab_wire.sym} -470 -80 0 0 {name=p28 sig_type=std_logic lab="Vin"}
...
C {devices/lab_wire.sym} -470 30 0 0 {name=p1 sig_type=std_logic lab="Vop"}
C {devices/lab_wire.sym} -460 80 0 0 {name=p2 sig_type=std_logic lab="Von"}
...
C {devices/vsource.sym} -810 -250 0 0 {name=V6 value="PULSE(0 3 0 200p 200p 5n 10n"}
C {devices/vsource.sym} 90 -240 0 0 {name=V2 value="sin(1 1 0.5meg)"
}
C {devices/vcvs.sym} -800 0 0 0 {name=E2 value=1}
C {devices/vcvs.sym} -800 90 0 0 {name=E3 value=1}
C {devices/res.sym} -680 60 0 0 {name=R2
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_wire.sym} -680 -60 0 0 {name=p4 sig_type=std_logic lab="Vicommon"}
C {devices/res.sym} -710 -10 0 0 {name=R3
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_wire.sym} -880 -40 0 0 {name=p5 sig_type=std_logic lab="Vip"}
C {devices/lab_wire.sym} -840 60 0 0 {name=p6 sig_type=std_logic lab="Vin"}
C {devices/vsource.sym} -540 -250 0 0 {name=V3 value="sin(1 1 1meg)"
}
C {devices/vcvs.sym} -690 270 0 0 {name=E5 value=1}
C {devices/vcvs.sym} -690 360 0 0 {name=E6 value=1}
C {devices/res.sym} -570 330 0 0 {name=R5
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_wire.sym} -570 210 0 0 {name=p7 sig_type=std_logic lab="Vocommon"}
C {devices/res.sym} -600 260 0 0 {name=R6
value=1k
footprint=1206
device=resistor
m=1}
C {devices/lab_wire.sym} -770 230 0 0 {name=p8 sig_type=std_logic lab="Vop"}
C {devices/lab_wire.sym} -730 330 0 0 {name=p9 sig_type=std_logic lab="Von"}
