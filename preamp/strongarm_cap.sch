...
C {devices/lab_wire.sym} -440 -550 0 0 {name=p23 sig_type=std_logic lab="Von"}
C {devices/lab_wire.sym} -290 -560 0 0 {name=p24 sig_type=std_logic lab="Vop"}
...
C {devices/capa.sym} -170 -540 0 0 {name=C2
m=1
value=0.6p
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} -630 -470 0 0 {name=l7 lab=GND}
C {devices/gnd.sym} -170 -510 0 0 {name=l8 lab=GND}
