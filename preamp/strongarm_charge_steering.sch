...
C {devices/lab_wire.sym} -440 -550 0 0 {name=p23 sig_type=std_logic lab="Vxn"}
C {devices/lab_wire.sym} -290 -560 0 0 {name=p24 sig_type=std_logic lab="Vxp"}
...
save all
tran 100p 15u 30n 
plot Vin Vip vidiff vodiff vicommon
plot vicommon vidiff vodiff
plot vin vip vop von
.endc"
}
...
C {devices/vsource.sym} -100 -320 0 0 {name=V2 value="sin(0 1 1meg)"
}
...
C {devices/vsource.sym} -180 -250 0 0 {name=V4 value="sin(1 0.5 50k)"
}
C {devices/vsource.sym} -500 -340 2 0 {name=V3 value="sin(0 1 1meg)"
}
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/nfet_03v3.sym} 450 -460 0 1 {name=M1
L=0.28u
W=0.22u
nf=1
m=1
...
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/nfet_03v3.sym} 200 -460 0 0 {name=M2
L=0.28u
W=0.22u
nf=1
m=1
...
C {devices/lab_wire.sym} 220 -570 0 0 {name=p16 sig_type=std_logic lab="Von"}
C {devices/lab_wire.sym} 370 -580 0 0 {name=p17 sig_type=std_logic lab="Vop"}
C {devices/lab_wire.sym} 130 -510 0 0 {name=p18 sig_type=std_logic lab="Vxn"}
C {devices/lab_wire.sym} 560 -500 0 0 {name=p19 sig_type=std_logic lab="Vxp"}
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/nfet_03v3.sym} 300 -300 0 0 {name=M3
L=0.28u
W=0.22u
nf=1
m=1
...
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/pfet_03v3.sym} 220 -650 0 0 {name=M4
L=0.28u
W=0.3u
nf=1
m=1
...
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/pfet_03v3.sym} 430 -650 0 1 {name=M5
L=0.28u
W=0.3u
nf=1
m=1
...
C {devices/gnd.sym} 60 -240 0 0 {name=l7 lab=GND}
C {devices/lab_wire.sym} 380 -720 0 0 {name=p20 sig_type=std_logic lab="Vdd"}
C {devices/lab_wire.sym} 170 -650 0 0 {name=p21 sig_type=std_logic lab="clk"
"}
C {devices/lab_wire.sym} 490 -660 0 0 {name=p22 sig_type=std_logic lab="clk"
"}
C {devices/lab_wire.sym} 260 -300 0 0 {name=p30 sig_type=std_logic lab="clk"
"}
C {devices/gnd.sym} 310 -490 0 0 {name=l8 lab=GND
m=8}
