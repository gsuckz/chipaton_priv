...
C {devices/vsource.sym} 110 -100 0 0 {name=V1 value="SIN(1.6 1m .1meg)"}
C {devices/vsource.sym} 190 -100 0 0 {name=V2 value="SIN(1.6 1m .2meg)"}
C {devices/vsource.sym} 260 -100 0 0 {name=V3 value="PULSE(0 3 0 100p 100p 5n 10n)"}
C {devices/gnd.sym} 110 -70 0 0 {name=l2 lab=GND}
C {devices/gnd.sym} 190 -70 0 0 {name=l3 lab=GND}
C {devices/gnd.sym} 260 -70 0 0 {name=l4 lab=GND}
C {devices/lab_wire.sym} 110 -140 0 0 {name=p4 sig_type=std_logic lab=Vin1}
C {devices/lab_wire.sym} 190 -140 0 0 {name=p5 sig_type=std_logic lab=Vin2}
C {devices/lab_wire.sym} 260 -140 0 0 {name=p6 sig_type=std_logic lab=clk
}
C {devices/vsource.sym} 340 -100 0 0 {name=V4 value=3.3}
C {devices/gnd.sym} 340 -70 0 0 {name=l5 lab=GND}
C {devices/lab_wire.sym} 340 -140 0 0 {name=p13 sig_type=std_logic lab=V
}
