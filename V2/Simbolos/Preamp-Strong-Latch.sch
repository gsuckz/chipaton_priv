...
lab=Vinp}
C {jesusu/Simbolos/SR_nand.sym} 2530 -1620 0 0 {name=X1}
C {jesusu/Simbolos/preamp.sym} 3760 -2920 0 0 {name=X3}
C {jesusu/Simbolos/strongarm.sym} 2570 -1890 0 0 {name=X4}
