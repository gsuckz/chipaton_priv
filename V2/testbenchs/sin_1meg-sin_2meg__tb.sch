...
C {devices/vsource.sym} 260 -130 0 0 {name=V3 value="PULSE(0 3 0 100p 100p 50n 100n)"}
C {devices/gnd.sym} 600 -150 0 0 {name=l1 lab=GND}
...
C {jesusu/V2/Symbols/preamp.sym} 140 270 0 0 {name=X3}
C {jesusu/V2/Symbols/strongarm.sym} -1050 1300 0 0 {name=X4}
C {devices/gnd.sym} 890 -180 0 0 {name=l9 lab=GND}
C {devices/lab_wire.sym} 600 -320 0 0 {name=p18 sig_type=std_logic lab=V
}
C {jesusu/V2/Symbols/SR_nor.sym} -1090 1570 0 0 {name=X1}
C {devices/gnd.sym} 1150 -190 0 0 {name=l10 lab=GND}
C {devices/lab_wire.sym} 1150 -330 0 0 {name=p23 sig_type=std_logic lab=V
}
C {SAR_ADC/SAR_ADC_gf180/xschem/spice/inv.sym} 550 -10 0 0 {name=x7 cl=0.28u wp=0.44u wn=0.22u}
C {devices/gnd.sym} 550 30 0 0 {name=l11 lab=GND}
C {devices/lab_wire.sym} 550 -50 0 0 {name=p24 sig_type=std_logic lab=V
}
C {devices/lab_wire.sym} 1320 -310 0 0 {name=p25 sig_type=std_logic lab=outcomp
}
